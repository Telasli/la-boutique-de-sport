...
class __TwigTemplate_9fddeb1d420815d3a547a0b05a4ef015 extends Template
{
    ...
    <div class=\"container my-5\">
        ...
        echo "
                <a href=\"";
        // line 16
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_cart_add", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 16, $this->source); })()), "id", [], "any", false, false, false, 16)]), "html", null, true);
        echo "\" class=\"btn btn-success w-100 mt-3\">Ajouter au panier</a>
            </div>
        </div>
...
";
    ...
    {
        return array (  103 => 16,  99 => 15,  95 => 14,  91 => 13,  83 => 12,  75 => 9,  68 => 4,  58 => 3,  35 => 1,);
    }
    ...
    <div class=\"container my-5\">
        ...
        <div class=\"row\">
            ...
            <div class=\"col-md-6\">
                ...
                <a href=\"{{ path('app_cart_add', { id : product.id } ) }}\" class=\"btn btn-success w-100 mt-3\">Ajouter au panier</a>
            </div>
        </div>
...
{% endblock %}
", "product/index.html.twig", "C:\\wamp64\\www\\la-boutique-de-sport\\templates\\product\\index.html.twig");
    }
}

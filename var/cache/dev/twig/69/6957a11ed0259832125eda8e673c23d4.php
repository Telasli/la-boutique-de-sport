...
class __TwigTemplate_18c8b10549320572eb2baddd7c9fcddd extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        <img src=\"/assets/img/sac-de-courses.png\" alt=\"Commande confirmée\">
        <h1>Merci pour votre commande</h1>

        <a href=\"";
        // line 8
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_account_order", ["id_order" => twig_get_attribute($this->env, $this->source, (isset($context["order"]) || array_key_exists("order", $context) ? $context["order"] : (function () { throw new RuntimeError('Variable "order" does not exist.', 8, $this->source); })()), "id", [], "any", false, false, false, 8)]), "html", null, true);
        echo "\" class=\"btn btn-success\">Consulter ma commande</a>
    </div>
";
...
{% block body %}
    <div class=\"container my-5 text-center\">
        ...
        <a href=\"{{ path('app_account_order', { 'id_order' : order.id } ) }}\" class=\"btn btn-success\">Consulter ma commande</a>
    </div>
{% endblock %}
", "payment/success.html.twig", "C:\\wamp64\\www\\la-boutique-de-sport\\templates\\payment\\success.html.twig");
    }
}
